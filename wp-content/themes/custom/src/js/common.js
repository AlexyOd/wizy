...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // document.querySelectorAll('.js-lang-switcher').forEach(function (root) {
    //     const btn = root.querySelector('.js-lang-switcher-trigger')
    //     const panel = root.querySelector('.js-lang-switcher-panel')
    //     const icon = root.querySelector('.js-lang-switcher-icon')
    //     if (!btn || !panel) return
