...
function jqueryIntegration() {
	...
	wp_register_script( 'jquery', get_template_directory_uri() . '/libs/jquery-3.4.1.min.js' );
...
function add_scripts() {
	...
	// wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/dist/css/bootstrap-5.3.3/bootstrap.min.js', '', '', true );
	...
	wp_enqueue_script( 'main', get_template_directory_uri() . '/dist/js/common.js', '', filemtime( get_template_directory() . '/dist/js/common.js' ), true ); // и скрипты шаблона
}
...
function add_styles() {
	...
	// wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/libs/bootstrap/css/bootstrap-grid.min.css' );
